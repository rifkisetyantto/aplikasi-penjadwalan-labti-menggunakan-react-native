        ...
        return(
            <View style={{flexDirection:'row'}}>
                ...
                <View style={{flexWrap:'wrap', borderWidth:1, height: 50, width:200, justifyContent:'center'}}>
                    <Text style={{textAlign:'center'}}>{this.props.dataa.MATA_PRAKTIKUM}</Text>
                </View>
...
export default class JadwalPraktikum extends React.Component {
  ...
  _renderModalContent = () => (
    <View style={{flex:1, justifyContent: "center", alignItems: "center"}}>
      <View style={{height:'80%',width:'95%',backgroundColor: "white", padding: 22, justifyContent: "center", alignItems: "center", borderRadius: 25, borderColor: "rgba(0, 0, 0, 0.1)"}}>
        ...
        <View style={{flexDirection:'column',justifyContent: "center", alignItems: "center", margin:10, marginBottom: 10}}>
            <Text style={{textAlign:'center', fontSize:15,}}>Nama Asisten : {this.state.nama_asisten}</Text>
        </View >
        <ScrollView>
            <ScrollView horizontal contentContainerStyle={{width: 725}}>           
    ...
    getJadwal(){
        ...
        if(x==""){
            ...
            console.log("masuk");
            fetch('https://labticare.000webhostapp.com/carijadwalAsisten.php', {
                method: 'POST',
                headers: 
                {
                ...
                id : x, //ini bikin buat di post ke PHP
                    ...
                    .then((responseJson) => {
                        if(responseJson == "Data Tidak Ditemukan"){
                            ...
                            this.setState({nama_asisten : this.state.jdwl[0].NAMA_ASISTEN});
                            console.log(this.state.jdwl);
                            this.toggleModal();//buat munculin modal
                            console.log(JSON.stringify(responseJson));
                            console.log(this.state.nama_asisten);
                        }
